...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/style_connecter/style_connected.css') }}?v={{ @filemtime(public_path('assets/css/style_connecter/style_connected.css')) ?: 1 }}">
    <!-- Bootstrap -->
...
<body>
    ...
    {{-- Pastille de publication : posee sur le viewport, hors du flux --}}
    <x-publish-fab />
